		...
		<div class="snippet-list">
			<div class="section-header-bar">
				<div class="section-header-buttons">
					<span class="section-header-button tag">Tags <i class="icon-chevron-down right"></i></span><span class="section-header-button version margin-right">Versions <i class="icon-chevron-down right"></i></span>
				</div>
